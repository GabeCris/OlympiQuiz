    ...
    <S.Question>
      ...
      <S.Duel>
        <S.Country>
          ...
          <Text fontSize={Font.EXTRA_SMALL} align="center">{competidor1.country_id}</Text>
        </S.Country>
        <Text fontSize={Font.MEDIUM} fontWeight="bold">X</Text>
        <S.Country>
          <Flag src={competidor2.country_flag_url} />
          <Text fontSize={Font.EXTRA_SMALL} align="center">{competidor2.country_id}</Text>
        </S.Country>
      </S.Duel>
    </S.Question>
  );
